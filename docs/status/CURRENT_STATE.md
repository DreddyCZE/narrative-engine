...
**Active task:** none
**Status:** TASK-021 is done. TASK-020 is done. TASK-019 is done. TASK-018 is done. TASK-017 is done. TASK-016 is done. TASK-015 is done. M2 planning outcome is READY_FOR_M2A after final acceptance review. M1 Contract Foundation review outcome is PASS after TASK-014 remediation. TASK-013 is done. TASK-014 is done. TASK-012 is done. TASK-011 is done. TASK-010 is done. TASK-004 through TASK-009 are done.

## Current Workflow

1. **Current milestone:** M2A/M2B - Shared Diagnostic Foundation.
2. **Current state:** TASK-021 is done; no ACTIVE task exists.
3. **Single next most important task:** Create and activate TASK-022 Effect applicator.
...
5. **How completion is recognized:** TASK-021 is accepted; the next scoped task is explicitly
...
- M2 planning is locally complete after TASK-015 acceptance; TASK-018 implementation is complete
  ...
  work is complete and accepted. TASK-021 condition work is done.
...
Do not start TASK-022 until TASK-021 is accepted, and the next scoped task is
