...
**Active task:** none
**Status:** TASK-016 is done. TASK-015 is done. M2 planning outcome is READY_FOR_M2A after final acceptance review. M1 Contract Foundation review outcome is PASS after TASK-014 remediation. TASK-013 is done. TASK-014 is done. TASK-012 is done. TASK-011 is done. TASK-010 is done. TASK-004 through TASK-009 are done.

## Current Workflow

1. **Current milestone:** M2A - Shared Foundations.
2. **Current state:** TASK-016 has been accepted; no ACTIVE task exists.
3. **Single next most important task:** Create and activate TASK-017 Entity Identity validator.
...
5. **How completion is recognized:** TASK-017 is created and activated explicitly; no ACTIVE task
   exists until that happens.
...
Do not start TASK-018 until TASK-017 is reviewed and accepted, and the next scoped task is
